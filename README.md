...
После запуска открывается окно браузера, для начало необходимо выбрать маштаб поиска, он отображается справа снизу. Чтобы увеличить/уменьшить маштаб вращаем колесиком мыши. Далее нажимаем ЛКМ и ставим точку на карте и нажимаем "Искать рядом".
